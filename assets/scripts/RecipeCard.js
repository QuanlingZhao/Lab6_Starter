...
class RecipeCard extends HTMLElement {
   ...
   */
    ...
    let articalEL = this.shadowRoot.querySelector("article")
    
    let imgSrc = data.imgSrc;
    let imgAlt = data.imgAlt;
    let titleLnk = data.titleLnk;
    let titleTxt = data.titleTxt;
    ...
    articalEL.innerHTML = `<img src="${imgSrc}"
    alt="${imgAlt}">
  <p class="title">
  ...
  <div class="rating">
    <span>"${rating}"</span>
    <img src="/assets/images/icons/${rating}-star.svg" alt="5 stars">
